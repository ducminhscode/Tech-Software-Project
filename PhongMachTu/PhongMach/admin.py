...
from PhongMach import app, db, dao
from PhongMach.models import Time, Medicine, Books, Cashier, Patient, MedicalForm, Doctor, Prescription, Receipt, ReceiptDetails, Rules, Administrator, Nurse
from flask_login import logout_user, current_user
from flask import redirect, request, jsonify
from PhongMach import utils
