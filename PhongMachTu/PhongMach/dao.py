...
from PhongMach.models import Patient, Account, Books, Time, Medicine, MedicalForm, Prescription, Cashier, Receipt, Rules
...
#
#
# def load_products(q=None, ctg=None, pm=None):
#     with open('data/products.json', encoding='utf-8') as f:
#         products = json.load(f)
#
#         if q:
#             products = [t for t in products if t["name"].find(q) >= 0]
#
#         if ctg:
#             products = [t for t in products if t["category_id"].__eq__(int(ctg))]
#
#         if pm:
#             products = [t for t in products]
#
#         return products
#
#
